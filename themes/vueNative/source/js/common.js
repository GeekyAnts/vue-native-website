(function() {
    ...
    if (apiContent) {
      ...
      apiTitles.forEach(function(titleNode) {
        ...
        if (methodMatch) {
          ...
          titleNode
            .querySelector("a")
            .setAttribute("href", "#" + idWithoutArguments);
        }
        ...
        if (ulNode.tagName === "UL") {
          ...
          specNode.innerHTML =
            '<a href="' + specLink + '" target="_blank">Source</a>';
  ...
  function initVideoModal() {
    ...
    document.body.addEventListener("click", function(e) {
      if (
        isOpen &&
        e.target !== modalButton &&
        !videoModal.contains(e.target)
      ) {
    ...
    versionSelect &&
      versionSelect.addEventListener("change", function(e) {
        ...
        window.location.assign(
          "https://" + version + (version && ".") + "vuejs.org/" + section + "/"
        );
      });
  }
      ...
      if (currentActive !== previousActive) {
        ...
        if (shouldScrollIntoView) {
          var currentPageOffset = currentPageAnchor
            ...
            : 0;
          var currentActiveOffset =
            currentActive.offsetTop + currentActive.parentNode.clientHeight;
          var sidebarHeight = sidebar.clientHeight;
          var currentActiveIsInView =
            currentActive.offsetTop >= sidebar.scrollTop &&
            currentActiveOffset <= sidebar.scrollTop + sidebarHeight;
          var linkNotFurtherThanSidebarHeight =
            currentActiveOffset - currentPageOffset < sidebarHeight;
