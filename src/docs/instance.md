...
Every Vue application has a **Vue instance** which you can import from:
...
A Vue application consists of a **root Vue instance** which you imported from `vue-native-core`, optionally organized into a tree of nested, reusable components. For example, a todo app's component tree might look like this:
